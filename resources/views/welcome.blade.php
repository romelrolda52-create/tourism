...
<head>
    ...
    <style>
        * {
        ...
        .header.scrolled .nav-links a:hover { color: var(--accent-light); }
        ...
        .btn-nav-signin:hover::before { left: 100%; }
        ...
        .btn-nav-signin i { font-size: 0.85rem; }
        ...
        .auth-container::after {
            ...
            background: radial-gradient(circle at bottom right, rgba(74,222,128,0.08) 0%, transparent 70%);
            pointer-events: none;
        }
        ...
        /* Hero content — now full width, centered */
        .hero-content {
            position: relative;
            z-index: 10;
            width: 100%;
        ...
        .section-title.dark::after { background: linear-gradient(90deg, var(--primary), var(--secondary)); }
        ...
        .card:hover { transform: translateY(-12px); box-shadow: 0 20px 50px rgba(0,0,0,0.15); }
        ...
        .card-img i { position: relative; z-index: 1; transition: transform 0.5s ease; }
        .card:hover .card-img i { transform: scale(1.15) rotate(5deg); }
        ...
        .card-text { color: #64748B; font-size: 0.95rem; line-height: 1.7; }
        ...
        .card-price::before { content: ''; width: 20px; height: 2px; background: var(--accent); }
        ...
        .feature:hover .feature-icon { transform: scale(1.1) rotate(-5deg); box-shadow: 0 15px 40px var(--accent-glow); }
        
        .feature-title { font-size: 1.2rem; font-weight: 600; margin-bottom: 12px; color: white; position: relative; z-index: 1; }
        .feature-text { color: var(--text-muted); font-size: 0.95rem; line-height: 1.7; position: relative; z-index: 1; }
        ...
        .cta-title { font-family: 'Playfair Display', serif; font-size: 3rem; font-weight: 700; color: white; margin-bottom: 18px; }
        .cta-text { font-size: 1.2rem; color: rgba(255,255,255,0.9); margin-bottom: 35px; max-width: 550px; margin-left: auto; margin-right: auto; line-height: 1.7; }
        ...
        @media (max-width: 500px) { .footer-grid { grid-template-columns: 1fr; text-align: center; } }
        ...
        .footer-brand span { color: var(--accent-light); font-style: italic; }
        
        .footer-desc { color: var(--text-muted); font-size: 0.95rem; line-height: 1.8; margin-bottom: 22px; }
        
        .social-links { display: flex; gap: 14px; }
        @media (max-width: 500px) { .social-links { justify-content: center; } }
        ...
        .social-link:hover { background: var(--accent); transform: translateY(-4px) scale(1.05); box-shadow: 0 8px 25px var(--accent-glow); border-color: var(--accent); }
        ...
        @media (max-width: 500px) { .footer-title::after { left: 50%; transform: translateX(-50%); } }
        ...
        @media (max-width: 500px) { .footer-links a:hover { transform: none; } }
        ...
        .btn-white:hover { transform: translateY(-3px); box-shadow: 0 8px 30px rgba(255,255,255,0.35); }
        ...
        .animate-fadeInUp { opacity: 0; animation: fadeInUp 0.7s ease forwards; }
        .animate-fadeInScale { opacity: 0; animation: fadeInScale 0.7s ease forwards; }
        ...
        .ken-burns-layer { position: absolute; inset: 0; z-index: 1; pointer-events: none; overflow: hidden; }
...
<body>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            <nav style="display: flex; align-items: center; justify-content: space-between;">
                ...
                <div style="display: flex; align-items: center; gap: 40px;">
                    ...
                    <button class="btn-nav-signin" onclick="openAuthModal('login')">
    ...
    <!-- ==================== AUTH MODAL ==================== -->
    <div class="modal-overlay" id="authModal" role="dialog" aria-modal="true" aria-label="Authentication">
        ...
        <div class="modal-panel">
            ...
            <div class="auth-container">
                <!-- Branding inside modal -->
                <div class="modal-brand">
                    <div class="modal-brand-icon">T</div>
                    <span class="modal-brand-name">TourEase <em>Pro</em></span>
                </div>
    ...
    <section class="hero" id="home">
        ...
        <!-- Hero Content — centered, no form -->
        <div class="hero-content">
            <div class="hero-text">
                <h1 class="animate-fadeInUp">{!! $welcomeContent->hero_title !!}</h1>
                <p class="animate-fadeInUp delay-100">{{ $welcomeContent->hero_description }}</p>
                <div class="hero-buttons animate-fadeInUp delay-200">
                    <a href="{{ $welcomeContent->hero_button_link }}" class="btn btn-primary">{{ $welcomeContent->hero_button_text }} <i class="fas fa-arrow-right"></i></a>
                    <a href="{{ $welcomeContent->hero_button2_link }}" class="btn btn-outline">{{ $welcomeContent->hero_button2_text }}</a>
                </div>
            </div>
        </div>
    ...
    <section class="stats-section">
        <div class="stats-grid">
            <div class="stat-item reveal stagger-1">
                <span class="stat-number" data-target="{{ $welcomeContent->stats_value1 }}">0</span>
                <span class="stat-label">{{ $welcomeContent->stats_title1 }}</span>
            </div>
            <div class="stat-item reveal stagger-2">
                <span class="stat-number" data-target="{{ $welcomeContent->stats_value2 }}">0</span>
                <span class="stat-label">{{ $welcomeContent->stats_title2 }}</span>
            </div>
            <div class="stat-item reveal stagger-3">
                <span class="stat-number" data-target="{{ $welcomeContent->stats_value3 }}">0</span>
                <span class="stat-label">{{ $welcomeContent->stats_title3 }}</span>
            </div>
            <div class="stat-item reveal stagger-4">
                <span class="stat-number" data-target="24" data-suffix="/7">0</span>
                <span class="stat-label">{{ $welcomeContent->stats_title4 }}</span>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="grid-3">
                ...
                <div class="card reveal-left stagger-1">
                    <div class="card-img"><i class="fas fa-mountain"></i></div>
                    <div class="card-body">
                ...
                <div class="card reveal-left stagger-2">
                    <div class="card-img"><i class="fas fa-umbrella-beach"></i></div>
                    <div class="card-body">
                ...
                <div class="card reveal-left stagger-3">
                    <div class="card-img"><i class="fas fa-city"></i></div>
                    <div class="card-body">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <button onclick="openAuthModal('register')" class="btn btn-white reveal">Get Started Free <i class="fas fa-arrow-right"></i></button>
        </div>
    </section>
        ...
        <div class="footer-grid">
            <div>
                <div class="footer-brand">
                    <div style="width: 44px; height: 44px; background: linear-gradient(135deg, var(--accent), var(--accent-light)); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; color: white; font-weight: 700; font-family: 'Playfair Display', serif;">T</div>
    ...
    <script>
        ...
        function switchTab(tab) {
            ...
            if (tab === 'login') {
                ...
                setTimeout(() => { loginForm.style.opacity = '1'; loginForm.style.transition = 'opacity 0.3s ease'; }, 10);
            } else {
                ...
                setTimeout(() => { registerForm.style.opacity = '1'; registerForm.style.transition = 'opacity 0.3s ease'; }, 10);
            }
        }
        ...
        const animateStats = () => {
            ...
            if (statsSection.getBoundingClientRect().top < window.innerHeight - 200) {
                statsAnimated = true;
        ...
        // ========== SLIDESHOW ==========
        const slideshowConfig = { interval: 5000, currentSlide: 0, totalSlides: 0, intervalId: null };
        ...
        const initSlideshow = () => {
            ...
            if (active) active.classList.add('ken-burns');
            startSlideshow();
        ...
        const goToSlide = (index) => {
            ...
            document.querySelectorAll('.hero-slide').forEach(s => s.classList.remove('active', 'ken-burns'));
        ...
        const nextSlide = () => {
            ...
            if (next >= slideshowConfig.totalSlides) next = 0;
            goToSlide(next);
        };
        ...
        const stopSlideshow = () => {
            if (slideshowConfig.intervalId) { clearInterval(slideshowConfig.intervalId); slideshowConfig.intervalId = null; }
        };
        
        const resetSlideshow = () => { stopSlideshow(); startSlideshow(); };
        ...
        document.addEventListener('DOMContentLoaded', () => {
            setTimeout(() => { revealOnScroll(); animateStats(); }, 100);
        });
    </script>
</body>
</html>