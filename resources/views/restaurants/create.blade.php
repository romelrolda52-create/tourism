...
<head>
    ...
    <title>Create Restaurant | Tourism Management</title>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new dining option to the platform</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <a href="{{ route('restaurants.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2.5 px-6 rounded-xl shadow-sm hover:shadow-md transition-all">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="max-w-4xl mx-auto">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border overflow-hidden">
                        <form method="POST" action="{{ route('restaurants.store') }}" enctype="multipart/form-data" class="p-8 space-y-8">
                            @csrf
                            <div>
                                ...
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" required
                                            ...
                                            placeholder="e.g. Golden Lotus Cuisine">
                                        @error('name')
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="location" value="{{ old('location') }}" required
                                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-all"
                                            placeholder="e.g. Boracay Beachfront">
                                        @error('location')
                                            <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                                <i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}
                                            </p>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" name="average_price" step="0.01" min="0" value="{{ old('average_price') }}" required
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="email" value="{{ old('email') }}"
                                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-all"
                                            placeholder="e.g. info@goldenlotus.com">
                                        @error('email')
                                            <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                                <i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}
                                            </p>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="description" rows="4" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-all resize-vertical"
                                            placeholder="Tell us about this restaurant...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                                <i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}
                                            </p>
                            ...
                            <div class="pt-6 border-t border-gray-200 dark:border-gray-700 flex items-center justify-end gap-4">
                                <a href="{{ route('restaurants.index') }}" class="px-8 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all font-semibold">
